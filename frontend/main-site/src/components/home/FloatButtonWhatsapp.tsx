...
export default function WhatsAppFloatButton() {
  ...
  const message = "Hello! I found your contact and would like to get in touch.";
  ...
  return (
    ...
    >
        ...
        <div className="mb-4 bg-white rounded-2xl shadow-2xl border border-gray-100 p-4 w-80 transform transition-all duration-300 ease-out animate-in slide-in-from-bottom-2">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2 transform hover:scale-[1.02] active:scale-[0.98]"
            >
      ...
      <button
        ...
        className="bg-green-500 hover:bg-green-600 text-white rounded-full w-16 h-16 flex items-center justify-center shadow-2xl transition-all duration-300 transform hover:scale-110 active:scale-95 relative overflow-hidden group"
      >
        {/* Ripple effect */}
